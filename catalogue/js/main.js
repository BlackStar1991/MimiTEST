...
$(document).ready(function() {
   ...
   //  var firstPhoto = $(".product_image").eq(1).attr('src');
   //
   // function activateZoomSlide(fixCurrentIndex){
   //
   //     $(".product_image").attr("data-zoom-image", "");
   //
   //
   //     console.log(firstPhoto + " =  firstPhoto ");
   //     var currentSrcBig = firstPhoto.split(".jpg").join( fixCurrentIndex + '-big.jpg"');
   //     console.log(currentSrcBig  + " =  currentSrcBig  ");
   //
   //
   //
   //     $(".product_image").eq(fixCurrentIndex).attr("data-zoom-image", "");
   //
   //     $(".product_image").eq(fixCurrentIndex).elevateZoom(
   //         {
   //             zoomWindowWidth: 470,
   //             zoomWindowHeight: 620,
   //             tintColour: "red"
   ...
   //
   //
   //  $(".product_image").eq(1).elevateZoom(
   //      {
   //          zoomWindowWidth: 470,
   //          zoomWindowHeight: 620,
   //          tintColour: "red"
   ...
   //  );
   //
   //  // var fullImages = $(".product_image").length;
   //
   //  $(".slick-slider-item").on("click", function () {
   //
   //     var correctIndex = 4;  ////////*  Это зависит от толичества слайдов в слайдере */
   //     var currentIndex = $(this).index() - correctIndex;
   //
   //      activateZoomSlide(currentIndex);
   //  });
   //
   //  $(".portfolio-thumb-slider .slick-next").on("click", function () {
   //
   //
   //
   //      var currentActiveSlide =  $(" .slick-slider-item.slick-active").index();
   //
   //      console.log(" currentActiveSlide  = " +  currentActiveSlide );
   //
   //
   //      var correctIndex = 4;  ////////*  Это зависит от толичества слайдов в слайдере */
   //      var indexCurrent = currentActiveSlide - correctIndex;
   //
   //      activateZoomSlide(indexCurrent);
   //
   //  });
   //

    //
    // var firstImg =  $(".product_image").eq(1);
    //
    // var currentDataZoom = firstImg.attr('data-zoom-image');
    //
    // console.log(currentDataZoom + " =  currentDataZoom ");
    //
    // var currentSrcBig = currentDataZoom.split(".").join("-big.");
